...
import           Seal.Util.Log (CanLog (..), LogContext, LoggingHandler,
                     Severity (..), WithLogger)
import           Seal.Util.Log.Internal (getConfig, getLogEnv, sev2klog)
import           Seal.Util.Log.LoggerConfig (LogHandler (..),
