...
# CSL-1509: After moving the 'seal' project itself into a separate folder ('lib/'), the 'seal-text.exe' executable fails on AppVeyor CI.
...
# Seal pieces, modulo the frontend
mkdir daedalus
...
copy seal-launcher.exe daedalus\
copy seal-node.exe daedalus\
copy seal-x509-certificates.exe daedalus\
cd daedalus
