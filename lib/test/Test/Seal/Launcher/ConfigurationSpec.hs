module Test.Seal.Launcher.ConfigurationSpec
    ( spec
    ) where
...
import           Seal.Launcher.Configuration (ConfigurationOptions (..),
                     WalletConfiguration, defaultConfigurationOptions,
                     withConfigurations)
import           Seal.Util.Config (ConfigurationException)
import           Seal.Util.Wlog (setupTestLogging)
...
spec :: Spec
spec = describe "Seal.Launcher.Configuration" $ do
