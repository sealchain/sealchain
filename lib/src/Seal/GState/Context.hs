...
import           Seal.Chain.Block (HasSlogGState (..), SlogGState)
import           Seal.DB.Block (cloneSlogGState)
import           Seal.DB.Lrc (HasLrcContext, LrcContext, cloneLrcContext)
import           Seal.DB.Pure (cloneDBPure)
import           Seal.DB.Sum (DBSum (..))
import           Seal.Infra.Slotting (HasSlottingVar, SlottingVar,
