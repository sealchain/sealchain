...
-- | Utilities related to the OutboundQueue and its place here in seal.

module Seal.Util.OutboundQueue
    ( OQ
...
import           Seal.Communication (Msg, NodeId, PackingType, PeerData)
import           Seal.Infra.Network.Types (Bucket)

-- | Specialization of OutboundQ for use in seal. Peers are identified
