...
module Seal.DB.Update.Poll.PollState
       (
         -- * Types
         PollState (PollState)
...
import           Seal.Core.Slotting (EpochIndex, SlottingData)
import           Seal.DB.Lrc (IssuersStakes)
import           Seal.Util.Modifier (foldlMapModWKey', modifyHashMap)
