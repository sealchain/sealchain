...
module Seal.DB.Delegation.Logic.Common
       (
       -- * Exceptions
         DelegationError(..)
...
import           Seal.Chain.Delegation (DelegationWrap (..), MonadDelegation,
...
import           Seal.DB.Delegation.Cede.Holders (runDBCede)
import           Seal.DB.Delegation.Cede.Logic (dlgLastPsk)
