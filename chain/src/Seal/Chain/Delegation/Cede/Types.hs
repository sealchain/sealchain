...
module Seal.Chain.Delegation.Cede.Types
       (
         DlgEdgeAction (..)
       , pskToDlgEdgeAction
       , dlgEdgeActionIssuer
...
import           Seal.Chain.Delegation.Types (isRevokePsk)
import           Seal.Core (StakeholderId, addressHash)
import           Seal.Crypto (pskIssuerPk)
...
-- Seal.Util.Modifier is something similar.
