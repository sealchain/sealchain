...
import           Seal.Binary.Class (Cons (..), Field (..), deriveSimpleBi,
                     deriveSimpleBiCxt)
import           Seal.Chain.Block.ComponentBlock (ComponentBlock (..))
import           Seal.Chain.Ssc.Behavior (SscBehavior)
...
import           Seal.Chain.Ssc.VssCertData as VCD
