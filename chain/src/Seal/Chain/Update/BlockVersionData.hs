...
module Seal.Chain.Update.BlockVersionData
       ( BlockVersionData (..)
       , ScriptVersion
       , isBootstrapEraBVD
       ) where
...
import           Seal.Core.Common (CoinPortion, TxFeePolicy)
import           Seal.Core.Slotting (EpochIndex, FlatSlotId, isBootstrapEra)
