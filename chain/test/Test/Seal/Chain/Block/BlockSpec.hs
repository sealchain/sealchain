...
-- | Specification of Seal.Chain.Block and Seal.Chain.Block.Pure.

module Test.Seal.Chain.Block.BlockSpec
       ( spec
       ) where
...
import           Seal.Chain.Block (BlockHeader (..), BlockSignature (..),
...
import           Seal.Core (EpochIndex (..), SlotId (..), difficultyL)
...
import           Test.Seal.Chain.Block.Arbitrary as BT
import           Test.Seal.Chain.Genesis.Dummy (dummyGenesisHash)
