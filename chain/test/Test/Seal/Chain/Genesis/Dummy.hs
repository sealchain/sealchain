...
module Test.Seal.Chain.Genesis.Dummy
       ( dummyConfig
...
import           Seal.Chain.Genesis (Config (..), FakeAvvmOptions (..),
...
import           Seal.Chain.Update (BlockVersionData (..), SoftforkRule (..))
import           Seal.Core (BlockCount, Coeff (..), EpochIndex (..),
