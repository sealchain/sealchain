module Test.Seal.Chain.Genesis.Gen
       ( genGenesisHash
       , genFakeAvvmOptions
...
import           Seal.Chain.Genesis (FakeAvvmOptions (..),
                     ...
                     mkGenesisSpec)
import           Seal.Core (TxFeePolicy (..))
import           Seal.Crypto (ProtocolMagic)

import           Test.Seal.Chain.Delegation.Gen (genProxySKHeavy)
import           Test.Seal.Chain.Ssc.Gen (genVssCertificatesMap)
import           Test.Seal.Chain.Update.Gen (genBlockVersionData,
                     genBlockVersionDataByTxFP)
import           Test.Seal.Core.Gen (genAddress, genCoin, genCoinPortion,
