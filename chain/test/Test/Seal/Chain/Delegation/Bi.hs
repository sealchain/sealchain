...
module Test.Seal.Chain.Delegation.Bi
       ( tests
       ) where
...
import           Seal.Chain.Delegation (DlgPayload (..), ProxySKBlockInfo)
...
import           Test.Seal.Chain.Delegation.Example (exampleLightDlgIndices,
                     ...
                     staticProxySKHeavys)
import           Test.Seal.Chain.Delegation.Gen (genDlgPayload, genHeavyDlgIndex,
