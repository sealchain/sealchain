module Test.Seal.Chain.Update.Gen
       ( genApplicationName
       , genBlockVersion
       , genBlockVersionData
...
import           Test.Seal.Util.Gen (genHashMap, genHashSet)
...
-- | Copied here from "Test.Seal.Chain.Block.Gen" to avoid module cycles
