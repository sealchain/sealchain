...
module Seal.Infra.Communication.Specs
       ( createOutSpecs
       ) where
...
import           Seal.Infra.Communication.Protocol (OutSpecs, convH, toOutSpecs)
import           Seal.Infra.Communication.Types.Relay (InvOrData, ReqOrRes)
