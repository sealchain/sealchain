...
module Seal.Infra.Slotting.Impl.Simple
...
import           Seal.Core.Slotting (MonadSlotsData, SlotCount, SlotId (..),
                     Timestamp (..), getCurrentNextEpochIndexM,
                     unflattenSlotId, waitCurrentEpochEqualsM)
import           Seal.Infra.Slotting.Impl.Util (approxSlotUsingOutdated,
                     slotFromTimestamp)
