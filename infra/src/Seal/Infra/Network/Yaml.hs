...
module Seal.Infra.Network.Yaml
       (
         Topology(..)
...
import           Seal.Infra.Network.DnsDomains (DnsDomains (..), NodeAddr (..),
                     extractNodeAddr)
import           Seal.Infra.Network.Types (Fallbacks, NodeName (..), Valency)
import           Seal.Util.Util (aesonError, toAesonError)

-- | Description of the network topology in a Yaml file
--
-- This differs from 'Seal.Infra.Network.Types.Topology' because for static nodes this
