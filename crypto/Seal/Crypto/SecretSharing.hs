...
module Seal.Crypto.SecretSharing
       ( -- * Keys and related.
         VssPublicKey (..)
       , VssKeyPair (..)
       , toVssPublicKey
...
-- 'runSecureRandom' from "Seal.Crypto.Random" because the OpenSSL generator
