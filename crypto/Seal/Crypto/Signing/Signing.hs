...
module Seal.Crypto.Signing.Signing
       (
       -- * Keys
         emptyPass
       , keyGen
       ...
       , module Seal.Crypto.Signing.Types.Signing
       ) where
...
import           Seal.Crypto.Signing.Check (checkSig, checkSigRaw,
                     validateProxySecretKey, verifyProxyCert)
import           Seal.Crypto.Signing.Tag (signTag)
import           Seal.Crypto.Signing.Types.Signing
import           Seal.Crypto.Signing.Types.Tag (SignTag)
...
-- of keypair from seed in sealchain-crypto API
...
-- from "Seal.Crypto.Random" because the OpenSSL generator is probably safer
