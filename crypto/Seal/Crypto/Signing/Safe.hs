...
module Seal.Crypto.Signing.Safe
       ( changeEncPassphrase
       , safeSign
       , safeToPublic
       , safeKeyGen
       ...
       , createProxyCert
       , createPsk
       , module Seal.Crypto.Signing.Types.Safe
       ) where
...
import qualified Seal.Crypto.Scrypt as S
import           Seal.Crypto.Signing.Signing (ProxyCert (..),
                     ProxySecretKey (..), PublicKey (..), SecretKey (..),
                     Signature (..), sign, toPublic)
import           Seal.Crypto.Signing.Tag (SignTag (SignProxySK), signTag)
import           Seal.Crypto.Signing.Types.Safe
...
-- "Seal.Crypto.Random" because the OpenSSL generator is probably safer than
