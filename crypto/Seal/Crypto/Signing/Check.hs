...
--
-- TODO: the "Seal.Crypto.Signing" hierarchy looks like a mess and should be
...
--
module Seal.Crypto.Signing.Check
       ( checkSig
       , checkSigRaw
       , verifyProxyCert
...
import           Seal.Crypto.Signing.Types (ProxyCert (..), ProxySecretKey (..),
