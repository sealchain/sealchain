module Seal.Crypto.Signing.Redeem
       ( redeemKeyGen
       , redeemDeterministicKeyGen
       , redeemSign
       , redeemCheckSig
       , module Seal.Crypto.Signing.Types.Redeem
       ) where
...
import           Seal.Crypto.Signing.Tag (SignTag, signTag)
import           Seal.Crypto.Signing.Types.Redeem
...
redeemDeterministicKeyGen seed =
    case maybeCryptoError $ Ed25519.secretKey $ fromByteStringToBytes seed of
        ...
        Nothing -> fail "Seal.Crypto.Signing.Redeem.hs redeemDeterministicKeyGen failed"
