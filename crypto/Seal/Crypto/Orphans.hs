...
import           Seal.Binary.Class (Bi (..), Size, decodeBinary, encodeBinary,
                     withWordSize)
...
fromCryptoFailable item (CryptoFailed e) = fail $ T.unpack $ "Seal.Crypto.Orphan." <> item <> " failed because " <> show e
