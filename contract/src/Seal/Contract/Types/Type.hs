...
-- |
-- Module      :  Seal.Contract.Types.Type
...
module Seal.Contract.Types.Type
 (
   ...
   PrimType(..),
   tyInteger,tyDecimal,tyTime,tyBool,tyString,tyKeyword,
...
tyInteger,tyDecimal,tyTime,tyBool,tyString,tyList,tyObject,tyValue,tyKeySet,tyTable,tyAddress,tyKeyword :: Text
tyInteger = "integer"
tyDecimal = "decimal"
tyTime = "time"
tyBool = "bool"
...
instance Show PrimType where
  ...
  show TyKeyword = unpack tyKeyword
