...
-- |
-- Module      :  Seal.Contract.Types.Term
...
module Seal.Contract.Types.Term
 (
   ...
   tStepEntity,tStepExec,tStepRollback,tTableName,tTableType,tValue,tVar,tInterfaceName,tVisibility,tNsName,
   ToTerm(..),
...
instance Monad Term where
    ...
    TNamespace na i >>= _ = TNamespace na i 
...
-- | Return a Seal.Contract type, or a String description of non-value Terms.
...
abbrev TNamespace{..} = "<namespace " ++ show _tNsName ++ ">"
