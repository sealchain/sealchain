-- | Specification of 'Seal.Core.SharedSeed' type

module Test.Seal.Core.SeedSpec
       (spec
       ) where
...
import           Seal.Core (SharedSeed)

import           Test.Seal.Core.Arbitrary ()
import           Test.Seal.Util.QuickCheck.Property (formsCommutativeMonoid)
