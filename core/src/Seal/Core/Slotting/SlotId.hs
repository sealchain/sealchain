...
module Seal.Core.Slotting.SlotId
       ( SlotId (..)
       , siEpochL
       , siSlotL
       , slotIdF
...
import           Seal.Core.Common (BlockCount)
import           Seal.Core.ProtocolConstants (kEpochSlots, kSlotSecurityParam)
import           Seal.Util.Util (intords, leftToPanic)

import           Seal.Core.Slotting.EpochIndex
import           Seal.Core.Slotting.LocalSlotIndex
