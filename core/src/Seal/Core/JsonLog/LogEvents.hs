...
module Seal.Core.JsonLog.LogEvents
       ( HasJsonLogConfig (..)
       , InvReqDataFlowLog (..)
       , JLEvent(..)
       , JLTxS (..)
...
import           Seal.Core (EpochIndex (..), SlotCount, SlotId (..),
                     mkLocalSlotIndex)
import           Seal.Core.JsonLog.JsonLogT (JsonLogConfig (..))
import qualified Seal.Core.JsonLog.JsonLogT as JL
import           Seal.Util.Util (realTime)
...
-- -----------------------------------------------------------------------------
-- This type was originally in Seal.Infra.Communication.Relay.Logic but was moved
